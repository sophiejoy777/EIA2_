...
(function (SKIPISTE) {
    ...
    var movingObjects = [];
    for (var i = 1; i < 40; i++) {
        movingObjects.push(new SKIPISTE.Snowflake(Math.floor(Math.random() * (800 + 1)), Math.floor(Math.random() * (600 + 1))));
    }
    movingObjects.push(new SKIPISTE.SkiFahrer(250, 300, "#27b4df", (Math.random() * 2) + 1));
    movingObjects.push(new SKIPISTE.SkiFahrer(300, 450, "#d84b20", (Math.random() * 2) + 1));
    movingObjects.push(new SKIPISTE.SkiFahrer(450, 500, "#7fb0b2", (Math.random() * 2) + 1));
    movingObjects.push(new SKIPISTE.SkiFahrer(500, 200, "#cf3476", (Math.random() * 2) + 1));
    movingObjects.push(new SKIPISTE.SkiFahrer(290, 340, "#cf3476", (Math.random() * 2) + 1));
    movingObjects.push(new SKIPISTE.SkiFahrer(450, 290, "#27b4df", (Math.random() * 2) + 1));
    movingObjects.push(new SKIPISTE.SkiFahrer(290, 190, "#7fb0b2", (Math.random() * 2) + 1));
    movingObjects.push(new SKIPISTE.SkiFahrer(560, 300, "#cf3476", (Math.random() * 2) + 1));
    //Sonne
    let Sundata = new SKIPISTE.sun(Math.random() * (0 - 400 + 1) + 360, Math.random() * (140 - 30 + 1) + 40);
    movingObjects.push(Sundata);
    //Update
    updateframe();
    function updateframe() {
        ...
        drawTree();
        drawLift();
        for (let element of movingObjects) {
            element.update();
        }
    }
    //Hintergrund
