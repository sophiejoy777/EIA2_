...
// Funktion um die Anzahl der Startkarten zu wählen

/*let handCard: number;

window.addEventListener("load", NumberOfCards)

function NumberOfCards(): void {
    let askForCards: number; 
    let question: string = prompt("How many start cards would you like?", "3-8");
    console.log(prompt)
    askForCards > 8 ? handCard = 8 : handCard < 4 ? handCard = 4 : handCard = askForCards;
}*/
